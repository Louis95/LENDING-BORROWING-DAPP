...
def main():
    ...
    #approve sending out our ERC20 token 
    ...
    tx.wait(1)
    print("Deposited!!......")
    borrowable_eth, total_depth = get_user_account_data(lending_pool, account)
...
def get_user_account_data(lending_pool, user_account):
    (
        ...
        ltv,
        health_factor
    ) = lending_pool.getUserAccountData(user_account.address)
